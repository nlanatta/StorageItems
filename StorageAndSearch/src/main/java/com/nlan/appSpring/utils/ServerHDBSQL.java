...
public class ServerHDBSQL {
	...
	{
		String table = "ITEM";
		String query = "CREATE TABLE "+table+" (ITEM_ID INT GENERATED BY DEFAULT AS IDENTITY(START WITH 0, INCREMENT BY 1)NOT NULL,"
	...
	private static void createCategoryTable(Statement statement) throws SQLException
	{
		...
		String query = "CREATE TABLE "+table+" (CATEGORY_ID INT GENERATED BY DEFAULT AS IDENTITY(START WITH 0, INCREMENT BY 1)NOT NULL,"
	...
	private static void createItemCategoryTable(Statement statement) throws SQLException
	{
		...
		String query = "CREATE TABLE "+table+" "
				+ "("
				+ "CATEGORY_ID INT GENERATED BY DEFAULT AS IDENTITY(START WITH 0, INCREMENT BY 1)NOT NULL,"
				+ "ITEM_ID INT GENERATED BY DEFAULT AS IDENTITY(START WITH 0, INCREMENT BY 1)NOT NULL,"
